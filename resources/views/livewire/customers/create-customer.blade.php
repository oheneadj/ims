<div class="max-w-4xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            <h1 class="text-3xl font-bold text-base-content">Add New Customer</h1>
            <p class="text-base-content/60 mt-1">Register a new client in your database.</p>
        </div>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-control md:col-span-2">
                        ...
                        <textarea wire:model="address" class="textarea textarea-bordered h-20 text-base"
                            placeholder="Street address, City, State..."></textarea>
            ...
            <section>
                ...
                <div class="form-control">
                    ...
                    <textarea wire:model="notes" class="textarea textarea-bordered h-24 text-base"
                        placeholder="Internal notes, preferences, or important details..."></textarea>
